...
class MapService {
  final String highlightPointsApiUrl =
      'http://192.168.1.88:3000/api/app/exhibit';
  final String mapsApiUrl = 'http://192.168.1.88:3000/api/app/map';
  ...
  Future<List<dynamic>> fetchAreaDetails(int areaId) async {
    final response = await http
        .get(Uri.parse('http://192.168.1.88:3000/api/app/artifacts/$areaId'));
    if (response.statusCode == 200) {
      final decodedBody = utf8.decode(response.bodyBytes);
